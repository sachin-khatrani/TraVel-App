...
class MapUtil{
  ...
  final directions = APIDirections.GoogleMapsDirections(apiKey: 'AIzaSyCXf-ZBDMyj9QX0thg32-2GZQMdo8MrsIQ');
  final geolocation = APIGeolocation.GoogleMapsGeolocation(apiKey: 'AIzaSyCXf-ZBDMyj9QX0thg32-2GZQMdo8MrsIQ');
