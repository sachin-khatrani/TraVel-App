import 'dart:async';
import 'package:travelapp/screens/home/user/src/config/configs.dart';
import 'package:travelapp/screens/home/user/src/model/place_item_res.dart';
import 'package:http/http.dart' as http;
import 'dart:convert';

import 'package:travelapp/screens/home/user/src/model/step_res.dart';

String dfsdfadf =
    "https://maps.googleapis.com/maps/api/directions/json?origin=Toronto&destination=Montreal&sensor=false&mode=driving&key=AIzaSyCXf-ZBDMyj9QX0thg32-2GZQMdo8MrsIQ";

class PlaceService {
  static Future<List<PlaceItemRes>> searchPlace(String keyWord) async {
    String url =
        "https://maps.googleapis.com/maps/api/place/textsearch/json?key=AIzaSyCXf-ZBDMyj9QX0thg32-2GZQMdo8MrsIQ&language=pt&query=" +
